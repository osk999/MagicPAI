...
/// <summary>
/// Replay-determinism guard for <see cref="ResearchPipelineWorkflow"/>. See
/// temporal.md §15.5.
/// </summary>
[Trait("Category", "Replay")]
public class ResearchPipelineReplayTests
{
    [Theory]
    [InlineData("Workflows/Histories/research-pipeline/happy-path-v1.json")]
    public async Task ReplaysSuccessfully(string historyPath)
    {
        ...
        var history = Temporalio.Common.WorkflowHistory.FromJson(
            workflowId: "replay-research-pipeline",
            json: json);
