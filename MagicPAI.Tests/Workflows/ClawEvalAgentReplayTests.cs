...
/// <summary>
/// Replay-determinism guard for <see cref="ClawEvalAgentWorkflow"/>. See
/// temporal.md §15.5.
/// </summary>
[Trait("Category", "Replay")]
public class ClawEvalAgentReplayTests
{
    [Theory]
    [InlineData("Workflows/Histories/claw-eval-agent/happy-path-v1.json")]
    public async Task ReplaysSuccessfully(string historyPath)
    {
        ...
        var history = Temporalio.Common.WorkflowHistory.FromJson(
            workflowId: "replay-claw-eval-agent",
            json: json);
